...
const MenuItem = (props: iProps) => {
    ...
    return (
        <div className="space-y-4 my-4">
            {
                itemCard.map(item => (
                    <div key={item.card.info.id} className="px-6 flex flex-row py-2 justify-between items-center space-x-4">
                        <div className="flex flex-col items-start">
                            ...
                            <p className="flex flex-row items-center">
                                <BiRupee />
                                <span className="mr-2 text-sm">{item?.card?.info?.price / 100}</span>
