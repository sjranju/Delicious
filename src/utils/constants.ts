export const RESTAURANT_API = 'https://corsproxy.org/?' + encodeURIComponent('https://www.swiggy.com/dapi/restaurants/list/v5?lat=12.979568962372062&lng=77.50290893018244&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING')

export const CLOUDINARY_URL = 'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/'

export const RESTAURANT_ITEM = 'https://corsproxy.org/?' + encodeURIComponent('https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=12.979568962372062&lng=77.50290893018244&restaurantId=')
...
export const GET_MORE_RESTAURANTS = 'https://corsproxy.org/?' + encodeURIComponent('https://www.swiggy.com/dapi/restaurants/list/update')

export const PRE_SEARCH = 'https://corsproxy.org/?' + encodeURIComponent('https://www.swiggy.com/dapi/landing/PRE_SEARCH?lat=12.979568962372062&lng=77.50290893018244')
